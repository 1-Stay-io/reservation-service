...
const dataGenListings = (callback) => {
  ...
  function write() {
    ...
    do {
      ...
      if (i === 0) {
        ...
        dataGenReservations(reservationId + 1, reviewAmount, startDate, listingInfo, callback);
        reservationId += reviewAmount;
      } else {
        ok = listingsWriter.write(listingInfo);
        reviewAmount = random(21);
...
const dataGenReservations = (startingId, reviewAmount, startDate, listingInfo, callback = () => null) => {
